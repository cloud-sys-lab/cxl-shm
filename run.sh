...
DATA_SIZE_MESSAGE=("128" "160" "192" "224" "256" "288" "320" "512" "1024" "2048")
...
do
    ...
    ./build/cxlmalloc-test-api 10 128 $size >> result.log
done

# message size 可以小于 block size吗？
DATA_SIZE_BLOCK=("32" "64" "128" "256" "512" "1024")
for size in "${DATA_SIZE_BLOCK[@]}"
do
    echo -n $size >> result.log
    ./build/cxlmalloc-test-api 10 $size 1024 >> result.log
done  